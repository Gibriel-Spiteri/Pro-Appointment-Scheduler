...
import { CalendarDays, Clock, MapPin, User, Building2, ChevronLeft } from "lucide-react";
    ...
    <div className="min-h-screen bg-background flex flex-col">
      <header className="border-b border-border bg-card px-6 py-4">
        <div className="max-w-2xl mx-auto flex items-center gap-3">
          ...
          <span className="text-base font-semibold text-foreground">Appointment Preview</span>
        </div>
      </header>
              ...
              {appointment.salesPersonName && (
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-sm font-medium text-foreground">{appointment.salesPersonName}</p>
                  </div>
                </div>
              )}
              ...
              <div className="border-t border-border pt-4">
                ...
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-xs text-muted-foreground mt-0.5">{appointment.customerEmail}</p>
                    <p className="text-xs text-muted-foreground mt-0.5">{appointment.customerPhone}</p>
                  </div>
                </div>
              </div>
